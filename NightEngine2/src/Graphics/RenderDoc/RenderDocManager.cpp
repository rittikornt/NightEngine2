...
namespace Rendering
{
  namespace RenderDocManager
  {
    ...
    bool Initialize()
    {
      ...
      if (g_attached)
      {
        Debug::Log << NightEngine::Logger::MessageType::WARNING
      ...
      if (g_renderDocDLL != nullptr)
      {
        ...
        {
          Debug::Log << NightEngine::Logger::MessageType::ERROR_MSG
      ...
      if (g_capturing && g_renderDocAPI != nullptr)
      {
        ...
        if (numCapture > 0)
        {
          ...
          char* filename = new char[pathLen];
          {
            ...
            if (launchRenderDoc)
            {
              // TODO: we might be able to somehow attach the renderdoc to NightEngine process
